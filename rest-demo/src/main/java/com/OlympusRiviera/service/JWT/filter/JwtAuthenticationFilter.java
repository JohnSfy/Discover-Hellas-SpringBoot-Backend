...
//
////            UserDetails userDetails = userDetailsService.loadUserByUsername(username);
//            UserDetails userDetails = userDetailsService.loadUserByGoogleId(username); // Assuming UserDetailsServiceImpl implements UserDetailsService interface
//
//            // Log to show when user details are loaded from database
//            System.out.println("User details loaded from database for username: " + username);
//
//            // Log to confirm the username extraction and JWT validation
//            System.out.println("Token validated for username: " + username);
//
